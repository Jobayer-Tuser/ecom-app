                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">${{ $product->productItems->first()->sale_price }}</span></ins>
                                                <ins><span class="old-price font-md ml-15">${{ $product->productItems->first()->price }}</span></ins>
                                        ...
                                        <div class="attr-detail attr-color mb-15">
                                            <strong class="mr-10">{{ ucfirst($product->productVariants->first()->variant_name) }}</strong>
                                            <ul class="list-filter color-filter">

                                                @php
                                                    $variantColour = explode(',', $product->productVariants->first()->variant_value);

                                                    collect($variantColour)->map(function ($item) {
                                                        echo '<li><a href="#" data-color="' . ucfirst($item) . '"><span class="product-color-' . $item . '"></span></a></li>';
                                                    })
                                                @endphp
                                        ...
                                        <div class="attr-detail attr-size">
                                            <strong class="mr-10">{{ ucfirst($product->productVariants[1]->variant_name) }}</strong>
                                            <ul class="list-filter size-filter font-small">
                                                @php
                                                    $variantColour = explode(',', $product->productVariants[1]->variant_value);

                                                    collect($variantColour)->map(function ($item) {
                                                        echo '<li><a href="#">'. ucfirst($item).'</a></li>';
                                                    })
                                                @endphp
                                                {{--<li><a href="#">S</a></li>
