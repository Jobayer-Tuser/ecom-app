...
@section('content')
    ...
    <div class="container text-center">
        @foreach($product->chunk(5) as  $chunk)
            <div class="row">
...
{{--                                        <img src="front/assets/imgs/shop/product-16-2.jpg" alt="product image">--}}
{{--                                    </figure>--}}
{{--                                    <figure class="border-radius-10">--}}
...
{{--                                    <div><img src="front/assets/imgs/shop/thumbnail-3.jpg" alt="product image"></div>--}}
...
{{--                                    <li class="social-facebook"><a href="#"><img src="front/assets/imgs/theme/icons/icon-facebook.svg" alt=""></a></li>--}}
{{--                                    <li class="social-twitter"> <a href="#"><img src="front/assets/imgs/theme/icons/icon-twitter.svg" alt=""></a></li>--}}
{{--                                    <li class="social-instagram"><a href="#"><img src="front/assets/imgs/theme/icons/icon-instagram.svg" alt=""></a></li>--}}
{{--                                    <li class="social-linkedin"><a href="#"><img src="front/assets/imgs/theme/icons/icon-pinterest.svg" alt=""></a></li>--}}
{{--                                </ul>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                <h3 class="title-detail mt-30">{{ $product->product['name'] }}</h3>--}}
...
{{--                                    <p class="font-sm">{{ $product->product['summary'] }}</p>--}}
{{--                                </div>--}}
...
{{--                                    <ul class="text-grey-5 d-inline-block">--}}
{{--                                        <li><strong class="mr-10">Share this:</strong></li>--}}
{{--                                        <li class="social-facebook"><a href="#"><img src="{{asset('front/assets/imgs/theme/icons/icon-facebook.svg')}}" alt=""></a></li>--}}
{{--                                        <li class="social-twitter"> <a href="#"><img src="{{asset('front/assets/imgs/theme/icons/icon-twitter.svg')}}" alt=""></a></li>--}}
{{--                                        <li class="social-instagram"><a href="#"><img src="{{asset('front/assets/imgs/theme/icons/icon-instagram.svg')}}" alt=""></a></li>--}}
{{--                                        <li class="social-linkedin"><a href="#"><img src="{{asset('front/assets/imgs/theme/icons/icon-pinterest.svg')}}" alt=""></a></li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                            <div class="col-md-6 col-sm-12 col-xs-12">--}}
{{--                                <div class="detail-info">--}}
{{--                                    <h2 class="title-detail">{{ $product->product['name'] }}</h2>--}}
{{--                                    <div class="product-detail-rating">--}}
{{--                                        <div class="pro-details-brand">--}}
{{--                                            <span> Brands: <a href="shop.html">Bootstrap</a></span>--}}
{{--                                        </div>--}}
...
{{--                                                                <img src="{{asset('front/assets/imgs/page/avatar-6.jpg')}}" alt="">--}}
...
{{--                                                        <div class="user justify-content-between d-flex">--}}
{{--                                                            <div class="thumb text-center">--}}
{{--                                                                <img src="{{asset('front/assets/imgs/page/avatar-7.jpg')}}" alt="">--}}
...
{{--                                                        <div class="user justify-content-between d-flex">--}}
{{--                                                            <div class="thumb text-center">--}}
{{--                                                                <img src="{{asset('front/assets/imgs/page/avatar-8.jpg')}}" alt="">--}}
