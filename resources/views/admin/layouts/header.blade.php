    ...
    <div class="menu">
        ...
        <div class="menu-item dropdown">
            <a href="#" data-bs-toggle="dropdown" data-display="static" class="menu-link">
                ...
                <div class="menu-text"><span class="__cf_email__"></span>{{ auth()->user()->name }}</div>
            </a>
            <div class="dropdown-menu dropdown-menu-right me-lg-3">
                <x-dropdown-link :href="route('profile.edit', auth()->user()->id)">{{ __('Profile Edit') }} <i class="fa fa-envelope fa-fw ms-auto text-dark text-opacity-50"></i> </x-dropdown-link>
                {{--<a class="dropdown-item d-flex align-items-center" href="{{route('profile.edit')}}">Edit Profile <i class="fa fa-user-circle fa-fw ms-auto text-dark text-opacity-50"></i></a>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-dropdown-link :href="route('logout')"
                        ...
                        {{ __('Log Out') }} <i class="fa fa-toggle-off fa-fw ms-auto text-dark text-opacity-50"></i>
                    </x-dropdown-link>
                </form>
            </div>
        </div>
